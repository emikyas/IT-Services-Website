...
const Home = () => {
    return (
        <React.Fragment>
            <div className="row bg-red pt-5 pb-5">
            ...
            <div className="row pt-5 pb-5">
                <div className="container">
                    <div className="row">
                        ...
                        <i data-mdb-toggle="animation" data-mdb-animation-reset="true" data-mdb-animation="slide-out-right" className="fas fa-car-side fa-3x">sdsdsdsdsd</i>
